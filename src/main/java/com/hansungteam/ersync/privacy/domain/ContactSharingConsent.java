...
public class ContactSharingConsent {
    ...
    private ContactSharingConsent(UserAccount account, String policyVersion, Instant consentedAt) {
    ...
    /** 사용자가 확인한 동의 문구 버전과 신뢰 가능한 서버 동의 시각을 기록합니다. */
    public static ContactSharingConsent record(
            UserAccount account,
            String policyVersion,
            Instant consentedAt
    ) {
        return new ContactSharingConsent(account, policyVersion, consentedAt);
    }
